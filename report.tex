...
such exchange. More specifically, every Pentagon domain consists of two 
...
\mypar{Mechanics of Pentagon join}
...
algorithm [citation] with logical operations – 1 AND and 1 OR in the innermost 
...
\mypar{Naive implementation - STL}
...
\mypar{Better naïve implementation – Dense matrix (DM)}
...
\mypar{Opportunities for improvement}
...
but as shown in [cite pueschel's paper], it can be relaxed through creating 
...
the approach described in [cite pueschel's paper] and [older paper]. The 
...
\mypar{Loop unrolling and scalar replacement}
